...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/html2pdf/vendor/jspdf.min.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/html2pdf/vendor/html2canvas.min.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/html2pdf/src/html2pdf.js'); ?>"></script>
