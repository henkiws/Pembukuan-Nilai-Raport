...
<div class="panel-body">
	<div class="col-lg-7">
		<table class="table table-striped table-hover display">
			...
			<form id="form" method="post" action="<?php echo base_url('index.php/wali_kelas/update_nilaiUTS'); ?>">
				<?php
		...
		?>
				<tr>
					...
					<td> 
						...
						<input type="number" class="form-control" name="nilai_uts[]" value="<?php echo $x->uts; ?>">
					</td>
				</tr>
		...
		?>	
			<tr>
				<td>Tahun Ajaran</td>
				<td><input type="text" class="form-control" name="tahun_ajaran" value="<?php echo $x->tahun_ajaran; ?>" disabled></td>
			</tr>
			<tr>
