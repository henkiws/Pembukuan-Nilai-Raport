...
<div class="row">
    <div class="col-lg-4 pull-left">
        <h4>Daftar Nilai Raport Semua Siswa</h4>
    </div>
...
<div class="panel-body">
	<div id="ini">
	<?php foreach($dataSiswaKelas as $x) { ?>
	<h4 align="center">LAPORAN  HASIL PENILAIAN<br>ULANGAN TENGAH SEMESTER I</h4>
	<hr>
	<div class="row">
			<div class="col-lg-6">
				<div class="col-lg-4">
...
<table border="1" id="ss" width="100%">
	...
	<tbody>
		...
		$no=1;
		$jmlUTS=0;
		$joinNilai=$this->m_crud->lihatJoinNilai($x->nis)->result();
		foreach($joinNilai as $n) {
		?>
		<tr>
			<td><?php echo "<center>".$no++; ?></td>
			<td><?php echo $n->nm_mapel; ?></td>
			<td><?php echo "<center>".$n->kkm; ?></td>
			<td><?php echo "<center>".$n->uts ?></td>
			<td>
				<?php
					//panggil fungsi terbilang
					echo terbilang($n->uts);
				?>
			</td>
			<td><?php if($n->uts>=$n->kkm){echo "<center>TUNTAS";}else{echo "<center>BELUM TUNTAS";} ?></td>
		</tr>
		<?php
		$jmlUTS=$jmlUTS+$n->uts;
			}
...
<div class="row">
	<div class="col-lg-4">
		...
		<table border="1"  width="100%">
			<?php
				$dataSiswa=$this->m_crud->lihatDataSelect('siswa','nis',$x->nis)->result();
...
<div class="row">
	...
	<?php } ?>
       ...
       $('#cmd').click(function () {
			...
			html2pdf(element, {
			  margin:       0.2,
			  filename:     'Raport UTS ALL-<?php echo $hari.'.pdf'; ?>',
